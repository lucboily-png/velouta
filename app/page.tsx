...
>
  <div
    style={{
      ...
      background:
        'linear-gradient(135deg,#fff7fa 0%, #fdf1f5 50%, #fffafb 100%)',
  ...
  >
    ...
    <div
      style={{
        ...
        borderRadius: '999px',
        background:
          'radial-gradient(circle, rgba(181,127,169,0.18), transparent 70%)',
      }}
    />
    ...
    >
      ...
      >
        Ici, tout ralentit.
        Tu peux enfin décrocher du bruit,
        des responsabilités et des journées trop chargées.
      </p>
      ...
      >
        Chaque conversation est conçue pour te faire sentir désirée,
        écoutée, valorisée… et complètement à l’aise d’être toi-même.
      </p>
      ...
      >
        Que tu recherches une présence rassurante,
        une complicité légère,
        un flirt assumé
        ou simplement quelqu’un avec qui partager un vrai moment,
        tout est à ton rythme.
      </p>
    </div>
    ...
    >
      {[
        {
          icon: '💫',
          title: 'Retrouver une énergie légère',
          text: 'Décrocher mentalement et vivre un moment qui fait réellement du bien.',
        },
        {
          icon: '🔥',
          title: 'Se sentir désirée',
          text: 'Retrouver cette sensation agréable d’attention, de séduction et de connexion.',
        },
        {
          icon: '🖤',
          title: 'Parler sans filtre',
          text: 'Exprimer librement tes pensées, tes envies ou simplement ton humeur du moment.',
        },
      ].map((item) => (
        <div
          key={item.title}
    ...
    <div
      style={{
        ...
        borderRadius: 30,
        background:
          'linear-gradient(135deg,#fff2f6,#fde8ef)',
        border: '1px solid rgba(139,94,131,0.08)',
        maxWidth: 760,
      }}
    >
      ...
      >
        Expérience privée • 100% confidentielle
      </div>
    </div>
  </div>
</section>
